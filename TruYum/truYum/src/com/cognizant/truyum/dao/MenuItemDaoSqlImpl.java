...
public class MenuItemDaoSqlImpl implements MenuItemDao {
	...
	public static final String GET_ALL_MENU_ITEM_ADMIN = "select * from menu_item";
	public static final String GET_ALL_MENU_ITEM_CUSTOMER = "select * from menu_item where me_active='Yes' and me_date_of_launch>(select curdate())";
