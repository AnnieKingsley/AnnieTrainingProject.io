...
public class MoviesDaoCollectionImpl implements MoviesDao {
	...
	public MoviesDaoCollectionImpl() {
		...
		if (moviesList == null) {
			...
			Movies itemTwo = new Movies(2L, "The Avengers", 1518812988L, true,new DateUtil().convertToDate("23/12/2017"), "Superhero", false);
			Movies itemThree = new Movies(3L, "Titanic", 2187463944L, true,new DateUtil().convertToDate("21/08/2018"), "Romance     ", false);
			Movies itemFour = new Movies(4L, "Jurasic World", 1671713208L, false,new DateUtil().convertToDate("02/07/2017"), "Science Fiction", true);
			Movies itemFive = new Movies(5L, "Avengers: End Game", 2750760348L, true,new DateUtil().convertToDate("02/11/2022"), "Superhero", true);
